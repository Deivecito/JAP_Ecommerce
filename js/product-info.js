...
function showProduct() {
    let htmlContentToAppend = "";
                ...
                htmlContentToAppend += `
                <p class="fs-2 mt-4 mb-4">${product.name}</p>
                <hr>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <img src="${product.images[0]}" class="img-thumbnail" alt="...">   
                            </div>
                            <div class="col">
                                <img src="${product.images[1]}" class="img-thumbnail" alt="...">
                            </div>
                            <div class="col">
                                <img src="${product.images[2]}" class="img-thumbnail" alt="...">
                            </div>
                            <div class="col">
                                <img src="${product.images[3]}" class="img-thumbnail" alt="...">
                            </div>
                        </div>
                    </div>
                </div>`;
...
document.getElementById('sendComment').addEventListener('click', () => {
    ...
    document.getElementById('comentarios').innerHTML += `<li class="list-group-item">
        <div class="row">
            <p class="mb-0"><strong>${localStorage.getItem("email")}</strong> - ${stars}</p> 
        </div>
        <div class="row">
